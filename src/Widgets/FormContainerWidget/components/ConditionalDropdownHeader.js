...
export const DropdownHeader = Scrivito.connect(({ widget, onChangeSelected }) => {
    return (
        <div className={`mb-3 dropdown-container ${Scrivito.isInPlaceEditingActive() ? "condition-wrapper" : ""}`}>
