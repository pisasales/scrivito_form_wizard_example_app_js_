...
export const RadioButtonsHeader = Scrivito.connect(({ widget, onChangeSelected }) => {
    return (
        <div className={`mb-3 select-container ${Scrivito.isInPlaceEditingActive() ? "condition-wrapper" : ""}`}>
